 ...
 */
@Service
public class MS023001GetTimeWorkSystemImpl implements MS023001GetTimeWorkSystemIService {
    ...
    @Override
    public BaseResponse GetTimeWorkSystem( int companyID) {
    	...
    	List<Object> result = step.stream().map(MS023001GetTimeWorkSystemResponse::new).collect(Collectors.toList());
